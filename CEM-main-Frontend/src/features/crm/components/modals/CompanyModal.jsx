...
export default function CompanyModal({ lead, leads = [], followups, onClose, onSave, onSaveFollowup, readOnly = false, allSellers = [], fetchAllSellers, handleReassign, setReassignConfirm, currentUser }) {
  ...
  const defaultStatus = lead.latestStatus || (STAGE_STATUS_MAP[lead.stage] && STAGE_STATUS_MAP[lead.stage][0]) || ALL_STATUSES[0];
  ...
  return (
    <Modal title={lead.companyName} onClose={onClose} wide width={1000}>
